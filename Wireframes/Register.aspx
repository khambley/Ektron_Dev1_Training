<%@ Page Title="" Language="C#" MasterPageFile="~/Source/Master Pages/MainMasterFixed.master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Source_Wireframes_Register" %>
            ...
            <div class="span8 ektron-content">
                ...
                <div class="ektron-large-bottom-margin">
                    ...
                    <p>
                        <div id="contact-form">
                            <fieldset>
                                <asp:Label ID="lblFirstname" runat="server"><%=Resources.Text.RegisterFirstNameLbl %></asp:Label>
                                <br />
                                <asp:TextBox ID="txtFirstName" runat="server"></asp:TextBox>
                                <br />
                                <asp:Label ID="lblLastname" runat="server"><%=Resources.Text.RegisterLastNameLbl %></asp:Label>
                                <br />
                                ...
                                <asp:Label ID="lblCountry" runat="server"><%=Resources.Text.RegisterCountryLbl %></asp:Label>
                                ...
                                <asp:Label ID="lblNews" runat="server"><asp:CheckBox ID="chkNews" runat="server" />
<%=Resources.Text.RegisterNewsLbl %></asp:Label>
                                <asp:Button ID="btncreateaccount" runat="server" Text="Create My Account" OnClick="btncreateaccount_Click" /><br /><br /><br />
                            </fieldset>
                        </div>
                    </p>
                </div>
